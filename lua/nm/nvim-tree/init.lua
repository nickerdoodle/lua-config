...
-- selectable.
-- vim.g.nvim_tree_special_files = { README.md' = true, Makefile: 1, 'MAKEFILE': 1 } -- List of filenames that gets highlighted with NvimTreeSpecialFile
...
nvim_tree_window_picker_exclude = {
	...
	nvim_tree_disable_window_picker = 1, --0 by default, will disable the window picker.

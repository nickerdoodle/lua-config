...
_G.packer_plugins = {
  ...
  ["nvim-lsp-config"] = {
    loaded = true,
    path = "/Users/nicholasmahe/.local/share/nvim/site/pack/packer/start/nvim-lsp-config"
  },
  ["nvim-lsp-installer"] = {
    loaded = true,
  ...
  vsc_html5_boilerplate = {
    loaded = true,
    path = "/Users/nicholasmahe/.local/share/nvim/site/pack/packer/start/vsc_html5_boilerplate"
  },
